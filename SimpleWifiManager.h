...
class SimpleWifiManager {
  ...
  private:
    ...
    const String html_part4_body_template1 = "<body><div class='container'><form action=\"/connect\"><div class='header'><div>Station Name: ";
    ...
    const String html_part5_body_connected_templatepart2 = "</h2></div><div class='header'><div>Station Name: ";
    ...
    const String html_part6_body_stationName_templatepart1 = "<body><div class='container'><form action=\"/station\"><div class=\"connected\"><p>Station Name:</p><h2>";
    const String html_part6_body_stationName_templatepart2 = "</h2></div><div class=\"header-vert\"><input id=\"stationName\" class=\"password\" name=\"stationName\" type=\"text\" placeholder=\"New Station Name\" /><input id=\"stationName\" class=\"password\" name=\"stationId\" type=\"text\" placeholder=\"New Station Id\" /><input id=\"password\" class=\"password\" name=\"password\" type=\"password\" placeholder=\"Enter Password\" /><button type=\"submit\" class=\"button\" id=\"connect\">Change</button></div></form></div>";
